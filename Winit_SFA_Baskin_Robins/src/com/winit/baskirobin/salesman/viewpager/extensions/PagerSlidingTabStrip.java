package com.winit.baskirobin.salesman.viewpager.extensions;
...
public class PagerSlidingTabStrip extends HorizontalScrollView
{
	...
	private int tabCount, currentPosition = 0;
	private float currentPositionOffset = 0f;
	private Paint rectPaint, dividerPaint;
	private int indicatorColor = Color.parseColor("#D85AA3"), underlineColor = Color.parseColor("#D85AA3"), dividerColor = Color.parseColor("#C2C7CD");//0x1A000000;
	private boolean shouldExpand = false, textAllCaps = false, checkedTabWidths = false;
	private int scrollOffset = 52, indicatorHeight = 8, underlineHeight = 2, dividerPadding = 12, tabPadding = 15, dividerWidth = 1;
	private int tabTextSize, tabTextColor = Color.parseColor("#D85AA3"), tabTextColorUnselected = Color.parseColor("#8A8A8A");
	private int tabBackgroundResId = R.drawable.background_tab;
	private Locale locale;
	private int mPosition = 0, devic_width, lastScrollX = 0;
	...
	public PagerSlidingTabStrip(Context context) {
		...
		tabTextSize = (int) mContext.getResources().getDimension(R.dimen.tab_text_size);
	}

	public PagerSlidingTabStrip(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		this.mContext = context;
		devic_width 	= AppConstants.DIVICE_WIDTH;
		tabTextSize = (int) mContext.getResources().getDimension(R.dimen.tab_text_size);
	}
...
public void setTabText(int position,int count) {
		
		((TextView)tabsContainer.getChildAt(position)).setText(pager.getAdapter().getPageTitle(position).toString()+" ("+count+")");
	}
	...
	private void addTextTab(final int position, String title) {
		...
		tab.setTypeface(AppConstants.Helvetica_LT_Condensed_Bold);
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if(i== mPosition)
			{
				...
				if(tabCount != 0 && tabCount <=2)
					defaultTabLayoutParams = new LinearLayout.LayoutParams(devic_width/tabCount, LayoutParams.MATCH_PARENT);
				else
