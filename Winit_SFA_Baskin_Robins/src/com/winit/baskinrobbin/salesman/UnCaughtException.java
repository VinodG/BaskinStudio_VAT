...
public class UnCaughtException implements UncaughtExceptionHandler {
	private static final String RECIPIENT = "prasanthdev@winitsoftware.com,prabhati@winitsoftware.com,rahulyadav@winitsoftware.com";
	...
	public void sendErrorMail(final StringBuilder errorContent) {
		...
		new Thread() {
			...
			public void run() {
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								Intent sendIntent = new Intent(
										Intent.ACTION_SEND);
								String subject = "Baskin Robbin SFA Log.";
				...
				builder.setMessage("Sorry for inconvenience. Baskin Robbins app stopped working.");
				builder.show();
				Looper.loop();
			}
		}.start();
