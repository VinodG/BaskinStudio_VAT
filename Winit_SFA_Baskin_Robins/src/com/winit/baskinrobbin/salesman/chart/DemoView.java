...
package com.winit.baskinrobbin.salesman.chart;
...
//        new SolidColor(Color.argb(0, 0, 255, 63));
        ...
        new SolidColor(Color.parseColor("#3366CC"));
        new SolidColor(Color.parseColor("#00CCCC"));
    ...
    private void zoom(PointF source, double startDistance, double endDistance) {
        ...
        if(plot instanceof Zoomable) {
            ...
            if (this.mScale * scaleDistance < 10.0f &&
                ...
                Zoomable z = (Zoomable) plot;
                z.zoomDomainAxes(scaleDistance, info, source, true);
                z.zoomRangeAxes(scaleDistance, info, source, true);
            }
        }
