...
public class ViewFlow extends AdapterView<Adapter>
{
	...
	private GalleryItemClickListener galleryItemListener;
	...
	{
		LogUtils.infoLog("getSelectedView","called");
		LinearLayout llSelectedView = (LinearLayout) (mCurrentBufferIndex < mLoadedViews.size() ? mLoadedViews.get(mCurrentBufferIndex) : null);
		((TextView)((RelativeLayout)llSelectedView.getChildAt(0)).getChildAt(1)).setVisibility(View.GONE);
    ...
    public int getSelectedItemPosition() {
    	LogUtils.infoLog("getSelectedView","called"+mCurrentAdapterIndex);
