...
public class InsertOrdersImagesParser extends BaseHandler
{
	...
	public InsertOrdersImagesParser(Context context) 
	{
		super(context);
	...
	public boolean updateOrders(Vector<AllUsersDo> vecOrderNumbers)
	{
		...
		result = new CommonDA().updateCustomerOrderNumbers(vecOrderNumbers);
		return result;
	}
	@Override
