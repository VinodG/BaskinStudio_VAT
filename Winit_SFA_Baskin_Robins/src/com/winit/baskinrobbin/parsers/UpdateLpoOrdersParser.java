...
public class UpdateLpoOrdersParser extends BaseHandler
{
	...
	public UpdateLpoOrdersParser(Context context) 
	{
		super(context);
	...
	public boolean updateOrders(Vector<AllUsersDo> vecOrderNumbers)
	{
		...
		result = new CommonDA().updateLpoOrderStatus(vecOrderNumbers);
		return result;
	}
	@Override
