...
public class InsertPaymetImagesParser extends BaseHandler
{
	...
	public InsertPaymetImagesParser(Context context) 
	{
		super(context);
	...
	public boolean updateOrders(Vector<AllUsersDo> vecOrderNumbers)
	{
		...
		result = new CommonDA().updatePaymentOrderNumbers(vecOrderNumbers);
		return result;
	}
	@Override
